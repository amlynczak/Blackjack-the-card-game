...
class Dealer():
    ...
    def dealers_turn(self, deck, screen, main_player, bot_players, card_images, font):
        ...
        while self.should_hit():
            ...
            display_game_state(screen, main_player, self, bot_players, card_images, font, True)
            time.sleep(3)
