...
class StartScreen:
    ...
    def run(self):
        ...
        while True:
            ...
            draw_text('Blackjack playing app', self.font, (255, 255, 255), self.screen, 225, 50)

            draw_button('Rozpocznij grę', self.button_font, (255, 255, 255), self.screen, 300, 200, 200, 50)
            draw_button('Zasady gry', self.button_font, (255, 255, 255), self.screen, 300, 300, 200, 50)
            draw_button('Ustawienia', self.button_font, (255, 255, 255), self.screen, 300, 400, 200, 50)
